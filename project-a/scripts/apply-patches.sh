...
YT_OPTS=(
  ...
  -e "Shorts autoplay"
  -e "Disable Shorts resuming on startup"
  -e "Open links externally"
  -e "Open system share sheet"
  -e "Open channel of live avatar"
  -e "Play all"
  # ── Reproductor ───────────────────────────────────────────────────
  -e "Swipe controls"
  ...
  -e "Video quality"
  -e "Alternative thumbnails"
  -e "Media notification controls"
  # ── UI / Limpieza ─────────────────────────────────────────────────
  -e "Theme"
  -e "Navigation bar"
  -e "Hide layout components"
  -e "Hide Shorts components"
  -e "Hide player flyout menu components"
  -e "Hide end screen cards"
  -e "Hide end screen suggested video"
  -e "Hide autoplay preview"
  -e "Hide related videos"
...
YTM_OPTS=(
  ...
  -e "Theme"
  -e "Navigation bar"
  -e "Miniplayer previous and next buttons"
  -e "Enable forced miniplayer"
