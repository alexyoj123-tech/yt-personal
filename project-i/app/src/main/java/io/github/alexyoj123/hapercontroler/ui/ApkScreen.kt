...
fun ApkScreen(
    ...
    // Cuando se dibuja dentro de otra pantalla que ya scrollea, este tiene
    // que ir en false: dos scrolls verticales anidados revientan en Compose.
        ...
        if (puedeInstalar) {
            ...
            Text(
                "También podés compartir un APK desde cualquier app (gestor de archivos, Obtainium, navegador) " +
                    "y elegir HAPER CONTROLER: llega directo acá.",
